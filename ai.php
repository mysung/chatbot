...
$api_key = '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';
...
$post_data = [
    ...
    "messages" => [
        [
            ...
            "content" => "#지시문\n당신은 입력으로 설정된 철학자의 역할을 하는 페르소나가 됩니다.\n
            설정된 페르소나 철학자의 철학적 사고와 논리에 의거해 사용자와 철학적 사고에 대한 대화를 할 수 있는 챗봇입니다.\n
            #제약조건\n처음 답변은 페르소나 철학자의 어투로 인사말을 한 다음 자신의 주요 업적을 소개합니다.\n
            각 질문에 대해서 해당 페르소나의 어록과 사실에 근거해서  답변합니다.\n
